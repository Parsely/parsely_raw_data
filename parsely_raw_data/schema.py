...
SCHEMA = [
    ...
    {"key": "campaign_id", "ex": "facebook_campaign", "type": str, "size": 256, "parent": "campaign"},
    {"key": "display", "ex": True, "type": bool},
    {"key": "display_avail_height", "ex": 735, "type": int, "parent": "display"},
    {"key": "display_avail_width", "ex": 1280, "type": int, "parent": "display"},
    {"key": "display_pixel_depth", "ex": 24, "type": int, "parent": "display"},
    {"key": "display_total_height", "ex": 800, "type": int, "parent": "display"},
    {"key": "display_total_width", "ex": 1280, "type": int, "parent": "display"},
    ...
    {"key": "metadata_authors", "ex": ["Laura Vitto"], "type": list, "parent": "metadata"},
    {"key": "metadata_canonical_url", "ex": "http://mashable.com/2016/09/07/airpods-jokes/", "type": str, "parent": "metadata"},
    {"key": "metadata_custom_metadata", "ex": "{\"site\":\"Mashable\"}", "type": str, "parent": "metadata"},
    {"key": "metadata_duration", "ex": None, "type": int, "parent": "metadata"},
    {"key": "metadata_data_source", "ex": 'crawl', "type": str, "size": 8, "parent": "metadata"},
    {"key": "metadata_full_content_word_count", "ex": 174, "type": int, "parent": "metadata"},
    {"key": "metadata_image_url", "ex": "http://a.amz.mshcdn.com/media/ZgkyMDE2LzA5LzA3LzU2L0NyeFhpNjNYRUFBSnZwRS5lNDAyMy5qcGcKcAl0aHVtYgkxMjAweDYzMAplCWpwZw/156d0173/3ae/CrxXi63XEAAJvpE.jpg", "type": str, "parent": "metadata"},
    {"key": "metadata_page_type", "ex": "post", "type": str, "size": 256, "parent": "metadata"},
    {"key": "metadata_post_id", "ex": "http://mashable.com/2016/09/07/airpods-jokes/", "type": str, "parent": "metadata"},
    {"key": "metadata_pub_date_tmsp", "ex": 1473275118000, "type": int, "date": True, "parent": "metadata"},
    {"key": "metadata_save_date_tmsp", "ex": 1473275204000, "type": int, "date": True, "parent": "metadata"},
    {"key": "metadata_section", "ex": "watercooler", "type": str, "size": 256, "parent": "metadata"},
    {"key": "metadata_share_urls", "ex": None, "type": list, "parent": "metadata"},
    {"key": "metadata_tags", "ex": ["gadgets", "iphone-7"], "type": list, "parent": "metadata"},
    {"key": "metadata_thumb_url", "ex": "https://images.parsely.com/xY9xNBMulGDKRMzfKaUQzs7A9PA=/160x160/smart/http%3A//a.amz.mshcdn.com/media/ZgkyMDE2LzA5LzA3LzU2L0NyeFhpNjNYRUFBSnZwRS5lNDAyMy5qcGcKcAl0aHVtYgkxMjAweDYzMAplCWpwZw/156d0173/3ae/CrxXi63XEAAJvpE.jpg", "type": str, "parent": "metadata"},
    {"key": "metadata_title", "ex": "Everyone has the same fear about Apple's new earbuds", "type": str, "parent": "metadata"},
    {"key": "metadata_urls", "ex": ["http://mashable.com/2016/09/07/airpods-jokes/"], "type": list, "parent": "metadata"},
    ...
    {"key": "session_id", "ex": 6, "type": int, "parent": "session"},
    {"key": "session_initial_referrer", "ex": "http://mashable.com/", "type": str, "parent": "session"},
    {"key": "session_initial_url", "ex": "http://mashable.com/", "type": str, "parent": "session"},
    {"key": "session_last_session_timestamp", "ex": 1473271351611, "type": int, "date": True, "parent": "session"},
    {"key": "session_timestamp", "ex": 1473277747806, "type": int, "date": True, "parent": "session"},
    ...
    {"key": "surl_utm_campaign", "ex": "facebook_campaign", "type": str, "size": 256, "parent": "url_query"},
    {"key": "surl_utm_medium", "ex": "partners", "type": str, "size": 64, "parent": "url_query"},
    {"key": "surl_utm_source", "ex": "facebook", "type": str, "size": 64, "parent": "url_query"},
    {"key": "surl_utm_term", "ex": "8098", "type": str, "size": 64, "parent": "url_query"},
    {"key": "surl_utm_content", "ex": "sports", "type": str, "size": 256, "parent": "url_query"},
    ...
    {"key": "timestamp_info_nginx_ms", "ex": 1473277850000, "type": int, "date": True, "req": True, "parent": "timestamp_info"},
    {"key": "timestamp_info_override_ms", "ex": None, "type": int, "date": True, "parent": "timestamp_info"},
    {"key": "timestamp_info_pixel_ms", "ex": 1473277850017, "type": int, "date": True, "parent": "timestamp_info"},
    ...
    {"key": "url_scheme", "ex": "http", "type": str, "size": 64, "parent": "url_query"},
    {"key": "utm_campaign", "ex": "facebook_campaign", "type": str, "size": 256, "parent": "url_query"},
    {"key": "utm_medium", "ex": "partners", "type": str, "size": 64, "parent": "url_query"},
    {"key": "utm_source", "ex": "facebook", "type": str, "size": 64, "parent": "url_query"},
    {"key": "utm_term", "ex": "8098", "type": str, "size": 64, "parent": "url_query"},
    {"key": "utm_content", "ex": "sports", "type": str, "size": 256, "parent": "url_query"},
    ...
    {"key": "visitor_ip", "ex": "108.225.131.20", "type": str, "size": 256, "parent": "visitor"},
    {"key": "visitor_network_id", "ex": "ac94fe31-a307-4020-9a23-fa4798217b02", "type": str, "size": 128, "parent": "visitor"},
    {"key": "visitor_site_id", "ex": "ab94fd31-a207-4010-8a25-fb4788207b82", "type": str, "size": 128, "req": True, "parent": "visitor"}
]
