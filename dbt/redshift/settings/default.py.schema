...
REDSHIFT_USER = 'redshift-user-here'
REDSHIFT_PASSWORD = 'redshift-password-here'
...
S3_AWS_ACCESS_KEY_ID = 'id-goes-here'
S3_AWS_SECRET_ACCESS_KEY = 'secret-goes-here'
S3_BUCKET_NAME = 'parsely-dw-bucket-name'
S3_NETWORK_NAME = 'bucket-name'  # everything after the `parsely-dw` in the bucket name
...
# The default is set to yesterday - today; If updated, please use the format 'YYYY-MM-DD'
...
ETL_TIME_ZONE = "'"+'America/New_York'+"'"
...
ETL_CUSTOM_EXTRA_DATA = "'"+'user_type'+"'"
